...
newBuff[1] = 5;
console.log(buf);
// <Buffer e4 b8 05 e5 96 84 e8 8b a5 e6 b0 b4>
...
console.log(buf1.toString());//上善�
console.log(buf2.toString());//��水

var StringDecoder = require('string_decoder').StringDecoder;
var decoder1 = new StringDecoder();
var decoder2 = new StringDecoder();
console.log(decoder1.write(buf1));//上善
console.log(decoder2.write(buf2));//��水
